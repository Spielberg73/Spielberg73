...
def _cargar(ruta: str, sistema_nombre: str = ""):
    ...
    if project.view == "carretera" and not sistema.dibuja_carreteras:
        _aviso("%s todavia no dibuja la carretera: el juego compila y se juega "
               ...
               % sistema.titulo)
    build = build_project(project, sistema.carretera_como)
...
def _compilador_de(sistema) -> str:
    candidatos = {
        ...
        "amiga1200": ["m68k-amigaos-gcc", "m68k-elf-gcc", "m68k-linux-gnu-gcc"],
        # el CD32 es un A1200 con lector de CD: mismo compilador
        "cd32": ["m68k-amigaos-gcc", "m68k-elf-gcc", "m68k-linux-gnu-gcc"],
...
def _como_instalar(sistema) -> str:
    return {
        ...
        "amiga1200": "apt install gcc-m68k-linux-gnu   (o m68k-amigaos-gcc)",
        "cd32": "apt install gcc-m68k-linux-gnu   (o m68k-amigaos-gcc)",
