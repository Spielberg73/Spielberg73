...
| | |
|---|---|
| `neoplat-docs-1.39.zip` | sólo la documentación: este README y todo `docs/`. Es lo que te llevas si quieres leerla o pasársela a otro proyecto |
| `neoplat-kit-1.39.zip` | el kit entero: motor, herramientas, ejemplo y pruebas, sin lo generado ni el historial |
| `neoplat-windows-1.39.zip` | el `ngplat.exe` y su LEEME |
